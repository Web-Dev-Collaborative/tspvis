    ...
    for (let pt1=1; pt1<path.length-1; pt1++) {
      for (let pt2=pt1+1; pt2<path.length-1; pt2++) {
        ...
        if (EVALUATING_DETAIL_LEVEL) {
          self.postMessage(_store_actions__WEBPACK_IMPORTED_MODULE_0__["setBestPaths"]([
            path.slice(0, pt1),
            path.slice(pt1+1, pt2),
            path.slice(pt2+1)
          ], best))
          self.postMessage(_store_actions__WEBPACK_IMPORTED_MODULE_0__["setIntermediatePaths"]([
...
/******/ });
//# sourceMappingURL=b2f372b912c796a7cf2c.worker.js.map