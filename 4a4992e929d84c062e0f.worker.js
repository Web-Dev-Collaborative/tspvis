...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/solvers/twoOpt.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: START_POINT_COLOR, POINT_COLOR, BEST_PATH_COLOR, EVALUATING_PATH_COLOR, EVALUATING_SEGMENT_COLOR */
...
const EVALUATING_PATH_COLOR=[255,87,34,240];// greyish
const EVALUATING_SEGMENT_COLOR=[180,180,180,240];

/***/ }),

/***/ "./src/solvers/twoOpt.worker.js":
/*!**************************************!*\
  !*** ./src/solvers/twoOpt.worker.js ***!
  \**************************************/
/*! no exports provided */
...
const twoOpt = async path => {
  let swapped = true;
  path.push(path[0])
  let best = _utils__WEBPACK_IMPORTED_MODULE_1__["pathCost"](path);
  self.postMessage(_store_actions__WEBPACK_IMPORTED_MODULE_0__["setBestPath"](path, best))
...
/******/ });
//# sourceMappingURL=4a4992e929d84c062e0f.worker.js.map