...
const run = async points => {
  ...
  while (remaining.length > 0) {
    ...
    if (EVALUATING_DETAIL_LEVEL) {
      self.postMessage(_store_actions__WEBPACK_IMPORTED_MODULE_0__["setEvaluatingPath"](path, _utils__WEBPACK_IMPORTED_MODULE_1__["pathCost"](path)))
    }
...
/******/ });
//# sourceMappingURL=b8ae8008afa5cd5b10a4.worker.js.map